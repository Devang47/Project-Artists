...
<section class="bg-dark w-100 h-100 text-white text-center   ">
  <div class="w-11/12 mx-auto py-20 px-5 flex flex-col items-center justify-centers lg:py-40">
    ...
    <h2 class="my-2 py-2 max-w-md mx-auto text-gray-200 lg:text-lg lg:max-w-xl lg:mt-6">
    ...
    <button
      class="bg-white rounded-md cursor-pointer duration-75 active:scale-95 hover:scale-105 py-2 px-4 mt-12 shadow hover:shadow-lg"
    >
      <img
        class="w-40 "
